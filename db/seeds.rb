...
# encoding: utf-8
Product.delete_all
Product.create!(title: 'Moon Man 1: Red Man',
  description:
    %{<p>
        An <em> elegantly</em> styled artwork inclusive upper and lower grament meant to be worn together
      </p>},
  image_url: 'moon_man.png',
  price: 199.95)
# . . .
